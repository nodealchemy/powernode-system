...
> Auto-generated by `rails system:skills:generate_catalog` on 2026-08-30 18:34 UTC.
...
- [`drift_remediate`](#drift_remediate) — Reconcile a NodeInstance's running modules against its assigned modules; returns a planned action set + estimated disruption %
