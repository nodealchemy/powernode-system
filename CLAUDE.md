...
1. Always check existing skill executors before writing a new orchestration. 65 already cover most fleet/SDWAN/runtime/topology workflows. See `docs/SKILL_EXECUTORS.md`.
...
- `docs/SKILL_EXECUTORS.md` — 65 executor reference; `docs/SKILL_EXECUTOR_CATALOG.md` is the auto-generated catalog (regenerate via `rails system:skills:generate_catalog` — never hand-edit)
...
- `docs/FLEET_SENSORS.md` — 37 fleet sensors (tick-registered) + 2 CVE sensors reference + intervention policy table (split per-agent post 2026-05-10)
