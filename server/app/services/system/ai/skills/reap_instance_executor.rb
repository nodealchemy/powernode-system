  ...
  module Ai
    module Skills
      ...
      class ReapInstanceExecutor < BaseSkillExecutor
        ...
        # Shared with the abandoned-instance reap; see
        # System::Fleet::ServiceBackendRelease for what STRANDED means.
        def remove_service_backends!(failed)
          ::System::Fleet::ServiceBackendRelease.release!(account: @account, instance: failed,
                                                          log_tag: "ReapInstanceExecutor")
        end
      end
    end
  end
