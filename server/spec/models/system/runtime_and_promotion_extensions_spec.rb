...
# Golden Eclipse M0.M — runtime telemetry (NodeInstance) extensions. The
# NodeModuleVersion promotion-lifecycle examples that shared this file were
# deleted with the decorative ladder (Environment campaign, increment 4b);
# what a plane runs now lives in spec/models/system/node_module_ladder_spec.rb.
RSpec.describe "Runtime telemetry extensions", type: :model do
